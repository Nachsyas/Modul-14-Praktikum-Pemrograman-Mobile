// Langkah (e): Import paket yang dibutuhkan
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:geolocator/geolocator.dart';
import 'package:geocoding/geocoding.dart';

// Langkah (f): Kelas MyApp
void main() {
  runApp(const MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const LocationScreen(), // Memanggil LocationScreen
    );
  }
}

// Langkah (g): Kelas LocationScreen (StatefulWidget)
// (Nama diubah dari GeolocationScreen agar cocok dengan panggilan di MyApp)
...
class _LocationScreenState extends State<LocationScreen> {
    ...
    try {
      ...
      if (placemarks.isNotEmpty) {
        ...
        setState(() {
          ...
          _kota =
              place.subAdministrativeArea; // subAdministrativeArea biasanya kota
        });
      } else {
  ...
  // Langkah (i): Tampilan UI (method build)
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
